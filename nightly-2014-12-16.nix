hackage:
  {
    packages = {
      ...
      "yesod-core".revision = hackage."yesod-core"."1.4.6.1".revisions.default;
      ...
      "shake-language-c".revision = hackage."shake-language-c"."0.6.2".revisions.default;
      ...
      "stackage".revision = hackage."stackage"."0.1.0.0".revisions.default;
      ...
      "resourcet".revision = hackage."resourcet"."1.1.3.2".revisions.default;
