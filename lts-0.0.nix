hackage:
  {
    packages = {
      ...
      "groundhog-th".flags.network-uri = false;
      ...
      "ghc-mtl".flags.network-uri = false;
      ...
      "scrobble".flags.network-uri = false;
      ...
      "http-reverse-proxy".flags.network-uri = false;
      ...
      "bzlib-conduit".flags.network-uri = false;
      ...
      "newtype".flags.network-uri = false;
      "warp".revision = hackage."warp"."3.0.4".revisions.default;
      ...
      "groups".flags.network-uri = false;
      ...
      "data-reify".flags.network-uri = false;
      ...
      "test-framework-hunit".flags.network-uri = false;
      "http-client".revision = hackage."http-client"."0.4.6".revisions.default;
      ...
      "http-client".flags.network-uri = false;
      "wai-conduit".revision = hackage."wai-conduit"."3.0.0.1".revisions.default;
      ...
      "wai-conduit".flags.network-uri = false;
      ...
      "diagrams-lib".flags.network-uri = false;
      ...
      "haddock-library".flags.network-uri = false;
      ...
      "libnotify".flags.network-uri = false;
      ...
      "foreign-store".flags.network-uri = false;
      "hoopl".revision = hackage."hoopl"."3.10.0.1".revisions.default;
      "wai-websockets".revision = hackage."wai-websockets"."3.0.0.2".revisions.default;
      ...
      "wai-websockets".flags.network-uri = false;
      ...
      "cookie".flags.network-uri = false;
      ...
      "time-lens".flags.network-uri = false;
      ...
      "hdevtools".flags.network-uri = false;
      "rest-client".revision = hackage."rest-client"."0.4.0.1".revisions.default;
      ...
      "rest-client".flags.network-uri = false;
      ...
      "semigroupoids".flags.network-uri = false;
      ...
      "byteorder".flags.network-uri = false;
      "conduit-combinators".revision = hackage."conduit-combinators"."0.3.0.4".revisions.default;
      ...
      "conduit-combinators".flags.network-uri = false;
      "free".revision = hackage."free"."4.9".revisions.default;
      ...
      "tf-random".flags.network-uri = false;
      ...
      "zip-archive".flags.network-uri = false;
      ...
      "traverse-with-class".flags.network-uri = false;
      "ghc".revision = hackage."ghc"."7.8.3".revisions.default;
      ...
      "json-schema".flags.network-uri = false;
      ...
      "openpgp-asciiarmor".flags.network-uri = false;
      ...
      "rest-stringmap".flags.network-uri = false;
      ...
      "shakespeare-text".flags.network-uri = false;
      ...
      "cereal".flags.network-uri = false;
      ...
      "xenstore".flags.network-uri = false;
      "Spock".revision = hackage."Spock"."0.7.5.1".revisions.default;
      ...
      "diagrams-postscript".flags.network-uri = false;
      ...
      "exceptions".flags.network-uri = false;
      ...
      "shakespeare".flags.network-uri = false;
      ...
      "sphinx".flags.network-uri = false;
      ...
      "YampaSynth".flags.network-uri = false;
      "runghc-7.8.3".revision = null;
      ...
      "NumInstances".flags.network-uri = false;
      ...
      "yesod-auth-deskcom".flags.network-uri = false;
      ...
      "Yampa".flags.network-uri = false;
      "ghci-7.8.3".revision = null;
      ...
      "hashable-extras".flags.network-uri = false;
      "yesod-bin".revision = hackage."yesod-bin"."1.4.1".revisions.default;
      ...
      "yesod-bin".flags.network-uri = false;
      ...
      "diagrams-contrib".flags.network-uri = false;
      ...
      "MissingH".flags.network-uri = false;
      ...
      "storable-endian".flags.network-uri = false;
      ...
      "seqloc".flags.network-uri = false;
      "hashtables".revision = hackage."hashtables"."1.1.2.1".revisions.default;
      ...
      "hashtables".flags.network-uri = false;
      ...
      "ghc-paths".flags.network-uri = false;
      ...
      "graphs".flags.network-uri = false;
      ...
      "hweblib".flags.network-uri = false;
      ...
      "monad-parallel".flags.network-uri = false;
      ...
      "cipher-aes".flags.network-uri = false;
      ...
      "fpco-api".flags.network-uri = false;
      ...
      "chunked-data".flags.network-uri = false;
      ...
      "rvar".flags.network-uri = false;
      "wl-pprint-text".revision = hackage."wl-pprint-text"."1.1.0.2".revisions.default;
      ...
      "wl-pprint-text".flags.network-uri = false;
      ...
      "accelerate".flags.network-uri = false;
      ...
      "pool-conduit".flags.network-uri = false;
      ...
      "testpack".flags.network-uri = false;
      ...
      "regexpr".flags.network-uri = false;
      ...
      "interpolate".flags.network-uri = false;
      ...
      "text-icu".flags.network-uri = false;
      ...
      "bytestring-progress".flags.network-uri = false;
      ...
      "biosff".flags.network-uri = false;
      ...
      "timezone-olson".flags.network-uri = false;
      ...
      "regex-tdfa".flags.network-uri = false;
      "pandoc".revision = hackage."pandoc"."1.13.1".revisions.default;
      ...
      "pandoc".flags.network-uri = false;
      "formatting".revision = hackage."formatting"."5.4".revisions.default;
      ...
      "formatting".flags.network-uri = false;
      ...
      "network-multicast".flags.network-uri = false;
      ...
      "stringable".flags.network-uri = false;
      ...
      "pipes-parse".flags.network-uri = false;
      ...
      "pipes-concurrency".flags.network-uri = false;
      ...
      "hslogger".flags.network-uri = false;
      ...
      "tls-debug".flags.network-uri = false;
      ...
      "mtl-prelude".flags.network-uri = false;
      ...
      "cryptohash-cryptoapi".flags.network-uri = false;
      ...
      "linear-accelerate".flags.network-uri = false;
      ...
      "hyphenation".flags.network-uri = false;
      ...
      "xml-types".flags.network-uri = false;
      ...
      "utf8-string".flags.network-uri = false;
      ...
      "polyparse".flags.network-uri = false;
      ...
      "streams".flags.network-uri = false;
      ...
      "pandoc-citeproc".flags.network-uri = false;
      ...
      "hspec-wai".flags.network-uri = false;
      "yesod-form".revision = hackage."yesod-form"."1.4.3".revisions.default;
      ...
      "yesod-form".flags.network-uri = false;
      ...
      "hebrew-time".flags.network-uri = false;
      ...
      "system-canonicalpath".flags.network-uri = false;
      ...
      "repa-algorithms".flags.network-uri = false;
      ...
      "biocore".flags.network-uri = false;
      ...
      "bifunctors".flags.network-uri = false;
      ...
      "numeric-extras".flags.network-uri = false;
      ...
      "Octree".flags.network-uri = false;
      ...
      "hspec-wai-json".flags.network-uri = false;
      ...
      "exception-transformers".flags.network-uri = false;
      ...
      "holy-project".flags.network-uri = false;
      ...
      "mysql".flags.network-uri = false;
      "cabal-src".revision = hackage."cabal-src"."0.2.3".revisions.default;
      ...
      "cabal-src".flags.network-uri = false;
      ...
      "logict".flags.network-uri = false;
      ...
      "x509-validation".flags.network-uri = false;
      ...
      "vector-space-points".flags.network-uri = false;
      ...
      "histogram-fill".flags.network-uri = false;
      ...
      "rest-wai".flags.network-uri = false;
      "yesod-core".revision = hackage."yesod-core"."1.4.6".revisions.default;
      ...
      "yesod-core".flags.network-uri = false;
      ...
      "MonadRandom".flags.network-uri = false;
      ...
      "mersenne-random-pure64".flags.network-uri = false;
      "skein".revision = hackage."skein"."1.0.9.1".revisions.default;
      ...
      "cipher-camellia".flags.network-uri = false;
      ...
      "snaplet-fay".flags.network-uri = false;
      ...
      "split".flags.network-uri = false;
      "groundhog-mysql".revision = hackage."groundhog-mysql"."0.7.0".revisions.default;
      ...
      "groundhog-mysql".flags.network-uri = false;
      ...
      "checkers".flags.network-uri = false;
      "stm".revision = hackage."stm"."2.4.3".revisions.default;
      ...
      "tasty-th".flags.network-uri = false;
      ...
      "heredoc".flags.network-uri = false;
      ...
      "SVGFonts".flags.network-uri = false;
      ...
      "generic-aeson".flags.network-uri = false;
      ...
      "rest-happstack".flags.network-uri = false;
      ...
      "hxt-relaxng".flags.network-uri = false;
      ...
      "control-monad-loop".flags.network-uri = false;
      ...
      "unix-time".flags.network-uri = false;
      ...
      "cipher-des".flags.network-uri = false;
      ...
      "monoid-extras".flags.network-uri = false;
      ...
      "hourglass".flags.network-uri = false;
      "case-insensitive".revision = hackage."case-insensitive"."1.2.0.1".revisions.default;
      ...
      "case-insensitive".flags.network-uri = false;
      ...
      "persistent-mongoDB".flags.network-uri = false;
      ...
      "data-lens-light".flags.network-uri = false;
      ...
      "barecheck".flags.network-uri = false;
      "xml-conduit".revision = hackage."xml-conduit"."1.2.3".revisions.default;
      ...
      "xml-conduit".flags.network-uri = false;
      ...
      "extensible-exceptions".flags.network-uri = false;
      ...
      "wl-pprint-terminfo".flags.network-uri = false;
      ...
      "csv-conduit".flags.network-uri = false;
      ...
      "tasty-quickcheck".flags.network-uri = false;
      ...
      "lifted-async".flags.network-uri = false;
      "network-uri".revision = hackage."network-uri"."2.5.0.0".revisions.default;
      ...
      "network-uri".flags.network-uri = false;
      ...
      "linear".flags.network-uri = false;
      ...
      "fuzzcheck".flags.network-uri = false;
      ...
      "uri-encode".flags.network-uri = false;
      ...
      "hopenpgp-tools".flags.network-uri = false;
      ...
      "ChasingBottoms".flags.network-uri = false;
      ...
      "crypto-random".flags.network-uri = false;
      ...
      "random-fu".flags.network-uri = false;
      ...
      "network-info".flags.network-uri = false;
      "authenticate".revision = hackage."authenticate"."1.3.2.10".revisions.default;
      ...
      "authenticate".flags.network-uri = false;
      ...
      "asn1-parse".flags.network-uri = false;
      ...
      "arithmoi".flags.network-uri = false;
      ...
      "pwstore-fast".flags.network-uri = false;
      ...
      "regex-base".flags.network-uri = false;
      ...
      "biofastq".flags.network-uri = false;
      ...
      "convertible".flags.network-uri = false;
      ...
      "libgit".flags.network-uri = false;
      ...
      "HCodecs".flags.network-uri = false;
      ...
      "mmorph".flags.network-uri = false;
      ...
      "concurrent-supply".flags.network-uri = false;
      ...
      "cmdargs".flags.network-uri = false;
      ...
      "threads".flags.network-uri = false;
      ...
      "easy-file".flags.network-uri = false;
      ...
      "certificate".flags.network-uri = false;
      ...
      "tabular".flags.network-uri = false;
      ...
      "dimensional".flags.network-uri = false;
      ...
      "esqueleto".flags.network-uri = false;
      ...
      "biofasta".flags.network-uri = false;
      ...
      "js-flot".flags.network-uri = false;
      ...
      "statistics".flags.network-uri = false;
      ...
      "data-binary-ieee754".flags.network-uri = false;
      ...
      "repa-io".flags.network-uri = false;
      ...
      "MonadPrompt".flags.network-uri = false;
      ...
      "ghc-heap-view".flags.network-uri = false;
      ...
      "MusicBrainz".flags.network-uri = false;
      ...
      "th-expand-syns".flags.network-uri = false;
      ...
      "classy-prelude".flags.network-uri = false;
      ...
      "immortal".flags.network-uri = false;
      ...
      "compensated".flags.network-uri = false;
      "ghc-7.8.3".revision = null;
      ...
      "haskell-names".flags.network-uri = false;
      ...
      "regex-posix".flags.network-uri = false;
      ...
      "atto-lisp".flags.network-uri = false;
      ...
      "monad-primitive".flags.network-uri = false;
      ...
      "postgresql-simple".flags.network-uri = false;
      ...
      "lazy-csv".flags.network-uri = false;
      ...
      "monad-extras".flags.network-uri = false;
      ...
      "pretty-class".flags.network-uri = false;
      "groundhog".revision = hackage."groundhog"."0.7.0".revisions.default;
      ...
      "groundhog".flags.network-uri = false;
      ...
      "shell-conduit".flags.network-uri = false;
      ...
      "courier".flags.network-uri = false;
      ...
      "fclabels".flags.network-uri = false;
      ...
      "double-conversion".flags.network-uri = false;
      ...
      "io-manager".flags.network-uri = false;
      ...
      "prettyclass".flags.network-uri = false;
      "system-fileio".revision = hackage."system-fileio"."0.3.15".revisions.default;
      ...
      "system-fileio".flags.network-uri = false;
      ...
      "project-template".flags.network-uri = false;
      ...
      "prefix-units".flags.network-uri = false;
      ...
      "cautious-file".flags.network-uri = false;
      ...
      "process-conduit".flags.network-uri = false;
      ...
      "hse-cpp".flags.network-uri = false;
      ...
      "biophd".flags.network-uri = false;
      "hs-bibutils".revision = hackage."hs-bibutils"."5.0".revisions.default;
      ...
      "hs-bibutils".flags.network-uri = false;
      ...
      "adjunctions".flags.network-uri = false;
      ...
      "hPDB-examples".flags.network-uri = false;
      ...
      "map-syntax".flags.network-uri = false;
      "mime-mail-ses".revision = hackage."mime-mail-ses"."0.3.2".revisions.default;
      ...
      "mime-mail-ses".flags.network-uri = false;
      ...
      "flexible-defaults".flags.network-uri = false;
      ...
      "enclosed-exceptions".flags.network-uri = false;
      ...
      "th-orphans".flags.network-uri = false;
      ...
      "composition".flags.network-uri = false;
      ...
      "concatenative".flags.network-uri = false;
      ...
      "vector-space".flags.network-uri = false;
      ...
      "asn1-data".flags.network-uri = false;
      ...
      "yesod-auth-hashdb".flags.network-uri = false;
      ...
      "chell-quickcheck".flags.network-uri = false;
      ...
      "bytestring-trie".flags.network-uri = false;
      ...
      "X11".flags.network-uri = false;
      "network-transport-tests".revision = hackage."network-transport-tests"."0.2.1.0".revisions.default;
      ...
      "network-transport-tests".flags.network-uri = false;
      "HaTeX".revision = hackage."HaTeX"."3.15.0.0".revisions.default;
      ...
      "markdown-unlit".flags.network-uri = false;
      ...
      "generic-deriving".flags.network-uri = false;
      ...
      "io-choice".flags.network-uri = false;
      ...
      "executable-path".flags.network-uri = false;
      ...
      "quickpull".flags.network-uri = false;
      ...
      "comonad-transformers".flags.network-uri = false;
      ...
      "basic-prelude".flags.network-uri = false;
      ...
      "blaze-textual".flags.network-uri = false;
      "glib".revision = hackage."glib"."0.13.0.6".revisions.default;
      ...
      "distributive".flags.network-uri = false;
      ...
      "binary-list".flags.network-uri = false;
      ...
      "wizards".flags.network-uri = false;
      ...
      "primes".flags.network-uri = false;
      ...
      "crypto-pubkey-types".flags.network-uri = false;
      "persistent-template".revision = hackage."persistent-template"."2.1".revisions.default;
      ...
      "persistent-template".flags.network-uri = false;
      ...
      "asn1-encoding".flags.network-uri = false;
      ...
      "vector-th-unbox".flags.network-uri = false;
      ...
      "zlib-enum".flags.network-uri = false;
      ...
      "hscolour".flags.network-uri = false;
      ...
      "OpenGLRaw".flags.network-uri = false;
      ...
      "present".flags.network-uri = false;
      "generics-sop".revision = hackage."generics-sop"."0.1.0.3".revisions.default;
      ...
      "generics-sop".flags.network-uri = false;
      "system-filepath".revision = hackage."system-filepath"."0.4.12".revisions.default;
      ...
      "system-filepath".flags.network-uri = false;
      ...
      "bytestring-builder".flags.network-uri = false;
      ...
      "random-source".flags.network-uri = false;
      ...
      "QuickCheck".flags.network-uri = false;
      ...
      "scientific".flags.network-uri = false;
      ...
      "attoparsec-conduit".flags.network-uri = false;
      "hmatrix".revision = hackage."hmatrix"."0.16.1.0".revisions.default;
      ...
      "hmatrix".flags.network-uri = false;
      ...
      "hOpenPGP".flags.network-uri = false;
      "stm-containers".revision = hackage."stm-containers"."0.2.4".revisions.default;
      ...
      "stm-containers".flags.network-uri = false;
      ...
      "language-haskell-extract".flags.network-uri = false;
      ...
      "hspec-discover".flags.network-uri = false;
      ...
      "aeson-qq".flags.network-uri = false;
      ...
      "zeromq4-haskell".flags.network-uri = false;
      ...
      "parallel".flags.network-uri = false;
      ...
      "language-java".flags.network-uri = false;
      ...
      "bytestring-mmap".flags.network-uri = false;
      ...
      "bioace".flags.network-uri = false;
      ...
      "monad-st".flags.network-uri = false;
      ...
      "errors".flags.network-uri = false;
      "haddock-api".revision = hackage."haddock-api"."2.15.0".revisions.default;
      ...
      "haddock-api".flags.network-uri = false;
      ...
      "text-format".flags.network-uri = false;
      "gl".revision = hackage."gl"."0.6.1".revisions.default;
      ...
      "haskell-src-meta".flags.network-uri = false;
      ...
      "fay-jquery".flags.network-uri = false;
      ...
      "css-text".flags.network-uri = false;
      ...
      "random".flags.network-uri = false;
      ...
      "temporary".flags.network-uri = false;
      ...
      "bytestring-lexing".flags.network-uri = false;
      ...
      "hybrid-vectors".flags.network-uri = false;
      ...
      "http-conduit".flags.network-uri = false;
      ...
      "optparse-applicative".flags.network-uri = false;
      ...
      "tagsoup".flags.network-uri = false;
      ...
      "statistics-linreg".flags.network-uri = false;
      ...
      "haskell-src".flags.network-uri = false;
      ...
      "wai-middleware-static".flags.network-uri = false;
      ...
      "prelude-extras".flags.network-uri = false;
      ...
      "profunctor-extras".flags.network-uri = false;
      "network".revision = hackage."network"."2.5.0.0".revisions.default;
      ...
      "network".flags.network-uri = false;
      ...
      "reroute".flags.network-uri = false;
      ...
      "crypto-api".flags.network-uri = false;
      ...
      "connection".flags.network-uri = false;
      "async".revision = hackage."async"."2.0.1.6".revisions.default;
      ...
      "stm-stats".flags.network-uri = false;
      ...
      "yesod-text-markdown".flags.network-uri = false;
      ...
      "groupoids".flags.network-uri = false;
      ...
      "interpolatedstring-perl6".flags.network-uri = false;
      ...
      "BlogLiterately-diagrams".flags.network-uri = false;
      ...
      "doctest".flags.network-uri = false;
      "haddock-ghc-7.8.3".revision = null;
      ...
      "containers-unicode-symbols".flags.network-uri = false;
      ...
      "arrow-list".flags.network-uri = false;
      ...
      "action-permutations".flags.network-uri = false;
      "yesod-sitemap".revision = hackage."yesod-sitemap"."1.4.0".revisions.default;
      ...
      "yesod-sitemap".flags.network-uri = false;
      ...
      "websockets".flags.network-uri = false;
      ...
      "AC-Vector".flags.network-uri = false;
      "conduit".revision = hackage."conduit"."1.2.3".revisions.default;
      ...
      "conduit".flags.network-uri = false;
      ...
      "partial-handler".flags.network-uri = false;
      ...
      "quandl-api".flags.network-uri = false;
      ...
      "x509-store".flags.network-uri = false;
      "persistent-postgresql".revision = hackage."persistent-postgresql"."2.1.1".revisions.default;
      ...
      "persistent-postgresql".flags.network-uri = false;
      "constraints".revision = hackage."constraints"."0.4".revisions.default;
      ...
      "constraints".flags.network-uri = false;
      ...
      "direct-sqlite".flags.network-uri = false;
      ...
      "lens-family-th".flags.network-uri = false;
      ...
      "HandsomeSoup".flags.network-uri = false;
      "monad-coroutine".revision = hackage."monad-coroutine"."0.8".revisions.default;
      ...
      "monad-coroutine".flags.network-uri = false;
      "crypto-pubkey".revision = hackage."crypto-pubkey"."0.2.5".revisions.default;
      ...
      "crypto-pubkey".flags.network-uri = false;
      ...
      "djinn-ghc".flags.network-uri = false;
      "semigroups".revision = hackage."semigroups"."0.16".revisions.default;
      ...
      "semigroups".flags.network-uri = false;
      ...
      "MaybeT".flags.network-uri = false;
      ...
      "data-default".flags.network-uri = false;
      ...
      "incremental-parser".flags.network-uri = false;
      ...
      "crypto-numbers".flags.network-uri = false;
      ...
      "html-conduit".flags.network-uri = false;
      ...
      "pureMD5".flags.network-uri = false;
      "highlighting-kate".revision = hackage."highlighting-kate"."0.5.11".revisions.default;
      ...
      "highlighting-kate".flags.network-uri = false;
      ...
      "bytedump".flags.network-uri = false;
      ...
      "integration".flags.network-uri = false;
      ...
      "vector-instances".flags.network-uri = false;
      "lifted-base".revision = hackage."lifted-base"."0.2.2.1".revisions.default;
      ...
      "lifted-base".flags.network-uri = false;
      "haddock".revision = null;
      "cairo".revision = hackage."cairo"."0.13.0.5".revisions.default;
      ...
      "hoogle".flags.network-uri = false;
      ...
      "data-default-instances-old-locale".flags.network-uri = false;
      ...
      "test-framework-th".flags.network-uri = false;
      ...
      "classy-prelude-conduit".flags.network-uri = false;
      ...
      "hashmap".flags.network-uri = false;
      ...
      "uniplate".flags.network-uri = false;
      "groundhog-sqlite".revision = hackage."groundhog-sqlite"."0.7.0".revisions.default;
      ...
      "groundhog-sqlite".flags.network-uri = false;
      ...
      "parsec".flags.network-uri = false;
      "slave-thread".revision = hackage."slave-thread"."0.1.4".revisions.default;
      ...
      "slave-thread".flags.network-uri = false;
      ...
      "rainbow".flags.network-uri = false;
      ...
      "th-reify-many".flags.network-uri = false;
      "ghcid".revision = hackage."ghcid"."0.3.2".revisions.default;
      ...
      "mysql-simple".flags.network-uri = false;
      ...
      "reducers".flags.network-uri = false;
      ...
      "statestack".flags.network-uri = false;
      ...
      "derive".flags.network-uri = false;
      "hp2ps".revision = null;
      ...
      "hxt-regex-xmlschema".flags.network-uri = false;
      ...
      "stylish-haskell".flags.network-uri = false;
      ...
      "tasty-ant-xml".flags.network-uri = false;
      ...
      "transformers-compat".flags.network-uri = false;
      ...
      "neat-interpolation".flags.network-uri = false;
      ...
      "hamlet".flags.test-hlint = false;
      "hamlet".flags.splitbase = true;
      "hamlet".flags.small_base = true;
      "hamlet".flags.https = true;
      "hamlet".flags.new-base = true;
      "hamlet".flags.blaze_html_0_5 = true;
      "hamlet".flags.old-locale = true;
      "hamlet".flags.bytestring-in-base = false;
      "hamlet".flags.network-uri = false;
      "hspec-expectations".revision = hackage."hspec-expectations"."0.6.1".revisions.default;
      ...
      "hspec-expectations".flags.network-uri = false;
      "mono-traversable".revision = hackage."mono-traversable"."0.6.3".revisions.default;
      ...
      "mono-traversable".flags.network-uri = false;
      "yesod-auth".revision = hackage."yesod-auth"."1.4.1".revisions.default;
      ...
      "yesod-auth".flags.network-uri = false;
      ...
      "dlist-instances".flags.network-uri = false;
      "yesod-static".revision = hackage."yesod-static"."1.4.0.3".revisions.default;
      ...
      "yesod-static".flags.network-uri = false;
      ...
      "comonads-fd".flags.network-uri = false;
      ...
      "sourcemap".flags.network-uri = false;
      "gio".revision = hackage."gio"."0.13.0.3".revisions.default;
      ...
      "vector".flags.network-uri = false;
      ...
      "primitive".flags.network-uri = false;
      ...
      "cryptohash".flags.network-uri = false;
      "cabal-install".revision = hackage."cabal-install"."1.18.0.5".revisions.default;
      ...
      "cabal-install".flags.network-uri = false;
      ...
      "type-eq".flags.network-uri = false;
      "texmath".revision = hackage."texmath"."0.8".revisions.default;
      ...
      "texmath".flags.network-uri = false;
      ...
      "rest-gen".flags.network-uri = false;
      ...
      "gtk2hs-buildtools".flags.network-uri = false;
      ...
      "profunctors".flags.network-uri = false;
      ...
      "bioalign".flags.network-uri = false;
      ...
      "rest-snap".flags.network-uri = false;
      ...
      "monadcryptorandom".flags.network-uri = false;
      ...
      "sodium".flags.network-uri = false;
      ...
      "blaze-builder".flags.network-uri = false;
      ...
      "pdfinfo".flags.network-uri = false;
      ...
      "ex-pool".flags.network-uri = false;
      ...
      "publicsuffixlist".flags.network-uri = false;
      ...
      "fb-persistent".flags.network-uri = false;
      ...
      "classy-prelude-yesod".flags.network-uri = false;
      ...
      "enumerator".flags.network-uri = false;
      ...
      "logfloat".flags.network-uri = false;
      ...
      "data-accessor".flags.network-uri = false;
      ...
      "Boolean".flags.network-uri = false;
      ...
      "base-compat".flags.network-uri = false;
      ...
      "utf8-light".flags.network-uri = false;
      ...
      "active".flags.network-uri = false;
      ...
      "language-javascript".flags.network-uri = false;
      "js-jquery".revision = hackage."js-jquery"."1.11.1".revisions.default;
      ...
      "js-jquery".flags.network-uri = false;
      ...
      "simple-reflect".flags.network-uri = false;
      ...
      "singletons".flags.network-uri = false;
      ...
      "terminal-size".flags.network-uri = false;
      ...
      "stringbuilder".flags.network-uri = false;
      ...
      "silently".flags.network-uri = false;
      ...
      "math-functions".flags.network-uri = false;
      ...
      "distributed-process-simplelocalnet".flags.network-uri = false;
      "ghc-pkg-7.8.3".revision = null;
      ...
      "regular-xmlpickler".flags.network-uri = false;
      ...
      "postgresql-binary".flags.network-uri = false;
      ...
      "regex-compat".flags.network-uri = false;
      ...
      "language-c".flags.network-uri = false;
      ...
      "time-compat".flags.network-uri = false;
      "concurrent-extra".revision = hackage."concurrent-extra"."0.7.0.8".revisions.default;
      ...
      "concurrent-extra".flags.network-uri = false;
      ...
      "lhs2tex".flags.network-uri = false;
      ...
      "monad-products".flags.network-uri = false;
      ...
      "monadic-arrays".flags.network-uri = false;
      ...
      "aeson-utils".flags.network-uri = false;
      ...
      "gravatar".flags.network-uri = false;
      ...
      "JuicyPixels-repa".flags.network-uri = false;
      ...
      "zlib-lens".flags.network-uri = false;
      "snap-server".revision = hackage."snap-server"."0.9.4.5".revisions.default;
      ...
      "snap-server".flags.network-uri = false;
      "deepseq-generics".revision = hackage."deepseq-generics"."0.1.1.1".revisions.default;
      ...
      "deepseq-generics".flags.network-uri = false;
      "yesod".revision = hackage."yesod"."1.4.1.1".revisions.default;
      ...
      "yesod".flags.network-uri = false;
      "hxt".revision = hackage."hxt"."9.3.1.7".revisions.default;
      ...
      "x509-system".flags.network-uri = false;
      ...
      "intervals".flags.network-uri = false;
      ...
      "ansi-terminal".flags.network-uri = false;
      ...
      "vector-binary-instances".flags.network-uri = false;
      "quickcheck-instances".revision = hackage."quickcheck-instances"."0.3.9".revisions.default;
      ...
      "quickcheck-instances".flags.network-uri = false;
      ...
      "data-accessor-mtl".flags.network-uri = false;
      ...
      "tagged".flags.network-uri = false;
      ...
      "bindings-DSL".flags.network-uri = false;
      ...
      "parsers".flags.network-uri = false;
      "yesod-newsfeed".revision = hackage."yesod-newsfeed"."1.4.0".revisions.default;
      ...
      "yesod-newsfeed".flags.network-uri = false;
      "cassava".revision = hackage."cassava"."0.4.2.0".revisions.default;
      ...
      "cassava".flags.network-uri = false;
      ...
      "haskell-src-exts".flags.network-uri = false;
      ...
      "hostname-validate".flags.network-uri = false;
      ...
      "syb-with-class".flags.network-uri = false;
      ...
      "OneTuple".flags.network-uri = false;
      "yesod-persistent".revision = hackage."yesod-persistent"."1.4.0.1".revisions.default;
      ...
      "yesod-persistent".flags.network-uri = false;
      ...
      "data-inttrie".flags.network-uri = false;
      ...
      "osdkeys".flags.network-uri = false;
      ...
      "safecopy".flags.network-uri = false;
      "xmlhtml".revision = hackage."xmlhtml"."0.2.3.3".revisions.default;
      ...
      "xmlhtml".flags.network-uri = false;
      ...
      "quickcheck-assertions".flags.network-uri = false;
      "base-prelude".revision = hackage."base-prelude"."0.1.6".revisions.default;
      ...
      "base-prelude".flags.network-uri = false;
      ...
      "reflection".flags.network-uri = false;
      ...
      "tagshare".flags.network-uri = false;
      ...
      "missing-foreign".flags.network-uri = false;
      ...
      "io-memoize".flags.network-uri = false;
      "yesod-websockets".revision = hackage."yesod-websockets"."0.2.0".revisions.default;
      ...
      "yesod-websockets".flags.network-uri = false;
      ...
      "compressed".flags.network-uri = false;
      ...
      "BoundedChan".flags.network-uri = false;
      ...
      "web-fpco".flags.network-uri = false;
      ...
      "dual-tree".flags.network-uri = false;
      ...
      "monoid-subclasses".flags.network-uri = false;
      "streaming-commons".revision = hackage."streaming-commons"."0.1.7.3".revisions.default;
      ...
      "streaming-commons".flags.network-uri = false;
      ...
      "punycode".flags.network-uri = false;
      ...
      "OpenGL".flags.network-uri = false;
      ...
      "clientsession".flags.network-uri = false;
      ...
      "email-validate".flags.network-uri = false;
      "hlint".revision = hackage."hlint"."1.9.13".revisions.default;
      ...
      "hlint".flags.network-uri = false;
      "hasql".revision = hackage."hasql"."0.4.0".revisions.default;
      ...
      "base-unicode-symbols".flags.network-uri = false;
      ...
      "text-binary".flags.network-uri = false;
      ...
      "shelly".flags.network-uri = false;
      ...
      "indents".flags.network-uri = false;
      ...
      "pcre-light".flags.network-uri = false;
      ...
      "fingertree".flags.network-uri = false;
      "MonadCatchIO-transformers".revision = hackage."MonadCatchIO-transformers"."0.3.1.2".revisions.default;
      ...
      "MonadCatchIO-transformers".flags.network-uri = false;
      ...
      "check-email".flags.network-uri = false;
      ...
      "haskell-lexer".flags.network-uri = false;
      ...
      "monad-par".flags.network-uri = false;
      ...
      "shakespeare-i18n".flags.network-uri = false;
      ...
      "temporary-rc".flags.network-uri = false;
      ...
      "ansi-wl-pprint".flags.network-uri = false;
      ...
      "happstack-server".flags.network-uri = false;
      ...
      "errorcall-eq-instance".flags.network-uri = false;
      ...
      "blaze-svg".flags.network-uri = false;
      ...
      "cereal-conduit".flags.network-uri = false;
      ...
      "Chart-diagrams".flags.network-uri = false;
      ...
      "markdown".flags.network-uri = false;
      "JuicyPixels".revision = hackage."JuicyPixels"."3.1.7.1".revisions.default;
      ...
      "JuicyPixels".flags.network-uri = false;
      ...
      "mwc-random".flags.network-uri = false;
      ...
      "hspec2".flags.network-uri = false;
      "wai".revision = hackage."wai"."3.0.2".revisions.default;
      ...
      "yesod-fay".flags.network-uri = false;
      ...
      "ghc-mod".flags.network-uri = false;
      ...
      "process-extras".flags.network-uri = false;
      ...
      "setenv".flags.network-uri = false;
      "test-framework".revision = hackage."test-framework"."0.8.0.3".revisions.default;
      ...
      "test-framework".flags.network-uri = false;
      ...
      "lens-aeson".flags.network-uri = false;
      ...
      "wl-pprint".flags.network-uri = false;
      "hledger-lib".revision = hackage."hledger-lib"."0.23.3".revisions.default;
      ...
      "hledger-lib".flags.network-uri = false;
      ...
      "hostname".flags.network-uri = false;
      ...
      "tasty-smallcheck".flags.network-uri = false;
      ...
      "heaps".flags.network-uri = false;
      "pango".revision = hackage."pango"."0.13.0.4".revisions.default;
      ...
      "hlibgit2".flags.network-uri = false;
      "yesod-test".revision = hackage."yesod-test"."1.4.2".revisions.default;
      ...
      "yesod-test".flags.network-uri = false;
      "either".revision = hackage."either"."4.3.2".revisions.default;
      ...
      "either".flags.network-uri = false;
      ...
      "cryptohash-conduit".flags.network-uri = false;
      ...
      "diagrams-builder".flags.network-uri = false;
      ...
      "directory-tree".flags.network-uri = false;
      ...
      "bool-extras".flags.network-uri = false;
      ...
      "system-posix-redirect".flags.network-uri = false;
      "vault".revision = hackage."vault"."0.3.0.3".revisions.default;
      ...
      "vault".flags.network-uri = false;
      "regular".revision = hackage."regular"."0.3.4.3".revisions.default;
      ...
      "regular".flags.network-uri = false;
      ...
      "cprng-aes".flags.network-uri = false;
      ...
      "control-monad-free".flags.network-uri = false;
      "mime-types".revision = hackage."mime-types"."0.1.0.4".revisions.default;
      ...
      "mime-types".flags.network-uri = false;
      ...
      "ieee754".flags.network-uri = false;
      ...
      "zlib-bindings".flags.network-uri = false;
      ...
      "language-ecmascript".flags.network-uri = false;
      ...
      "sendfile".flags.network-uri = false;
      "warp-tls".revision = hackage."warp-tls"."3.0.1".revisions.default;
      ...
      "warp-tls".flags.network-uri = false;
      ...
      "charset".flags.network-uri = false;
      ...
      "fay-builder".flags.network-uri = false;
      ...
      "th-desugar".flags.network-uri = false;
      ...
      "QuasiText".flags.network-uri = false;
      ...
      "force-layout".flags.network-uri = false;
      ...
      "http-client-tls".flags.network-uri = false;
      ...
      "mongoDB".flags.network-uri = false;
      ...
      "contravariant".flags.network-uri = false;
      ...
      "graph-core".flags.network-uri = false;
      ...
      "stringprep".flags.network-uri = false;
      ...
      "GLURaw".flags.network-uri = false;
      ...
      "messagepack".flags.network-uri = false;
      ...
      "persistent-mysql".flags.network-uri = false;
      ...
      "cipher-blowfish".flags.network-uri = false;
      ...
      "rank1dynamic".flags.network-uri = false;
      "bloodhound".revision = hackage."bloodhound"."0.4.0.2".revisions.default;
      ...
      "bloodhound".flags.network-uri = false;
      ...
      "network-transport-tcp".flags.network-uri = false;
      ...
      "xss-sanitize".flags.network-uri = false;
      ...
      "data-default-instances-dlist".flags.network-uri = false;
      ...
      "parseargs".flags.network-uri = false;
      ...
      "attoparsec-expr".flags.network-uri = false;
      "snap-core".revision = hackage."snap-core"."0.9.6.3".revisions.default;
      ...
      "snap-core".flags.network-uri = false;
      ...
      "securemem".flags.network-uri = false;
      ...
      "nettle".flags.network-uri = false;
      ...
      "hinotify".flags.network-uri = false;
      ...
      "hdaemonize".flags.network-uri = false;
      ...
      "storable-complex".flags.network-uri = false;
      ...
      "network-simple".flags.network-uri = false;
      ...
      "monad-journal".flags.network-uri = false;
      "pointed".revision = hackage."pointed"."4.1".revisions.default;
      ...
      "pointed".flags.network-uri = false;
      "distributed-process".revision = hackage."distributed-process"."0.5.2".revisions.default;
      ...
      "distributed-process".flags.network-uri = false;
      ...
      "BlogLiterately".flags.network-uri = false;
      ...
      "fay-dom".flags.network-uri = false;
      ...
      "crypto-cipher-types".flags.network-uri = false;
      ...
      "ReadArgs".flags.network-uri = false;
      ...
      "filemanip".flags.network-uri = false;
      ...
      "djinn-lib".flags.network-uri = false;
      "blaze-markup".revision = hackage."blaze-markup"."0.6.1.1".revisions.default;
      ...
      "blaze-markup".flags.network-uri = false;
      ...
      "postgresql-libpq".flags.network-uri = false;
      ...
      "fay-uri".flags.network-uri = false;
      ...
      "sqlite-simple".flags.network-uri = false;
      ...
      "tasty-golden".flags.network-uri = false;
      ...
      "hsyslog".flags.network-uri = false;
      "uuid".revision = hackage."uuid"."1.3.5".revisions.default;
      ...
      "uuid".flags.network-uri = false;
      "persistent".revision = hackage."persistent"."2.1.1".revisions.default;
      ...
      "persistent".flags.network-uri = false;
      ...
      "cipher-rc4".flags.network-uri = false;
      ...
      "configurator".flags.network-uri = false;
      "text".revision = hackage."text"."1.1.1.3".revisions.default;
      ...
      "text".flags.network-uri = false;
      "Cabal".revision = hackage."Cabal"."1.18.1.3".revisions.default;
      ...
      "unordered-containers".flags.network-uri = false;
      ...
      "base64-bytestring".flags.network-uri = false;
      ...
      "aeson-pretty".flags.network-uri = false;
      ...
      "HStringTemplate".flags.network-uri = false;
      "ghc-pkg".revision = null;
      "base".revision = hackage."base"."4.7.0.1".revisions.default;
      ...
      "blaze-builder-enumerator".flags.network-uri = false;
      ...
      "monads-tf".flags.network-uri = false;
      ...
      "tagstream-conduit".flags.network-uri = false;
      ...
      "frisby".flags.network-uri = false;
      ...
      "multimap".flags.network-uri = false;
      ...
      "testing-feat".flags.network-uri = false;
      "keter".revision = hackage."keter"."1.3.6".revisions.default;
      ...
      "bumper".flags.network-uri = false;
      ...
      "abstract-deque".flags.network-uri = false;
      ...
      "FenwickTree".flags.network-uri = false;
      ...
      "hspec-meta".flags.network-uri = false;
      ...
      "udbus".flags.network-uri = false;
      "hledger".revision = hackage."hledger"."0.23.3".revisions.default;
      ...
      "hledger".flags.network-uri = false;
      ...
      "comonad".flags.network-uri = false;
      ...
      "hspec".flags.network-uri = false;
      "diagrams-cairo".revision = hackage."diagrams-cairo"."1.2.0.4".revisions.default;
      ...
      "diagrams-cairo".flags.network-uri = false;
      ...
      "diagrams-haddock".flags.network-uri = false;
      ...
      "data-default-class".flags.network-uri = false;
      ...
      "timezone-series".flags.network-uri = false;
      ...
      "yesod-fb".flags.network-uri = false;
      ...
      "xmlgen".flags.network-uri = false;
      ...
      "xml-hamlet".flags.network-uri = false;
      ...
      "base16-bytestring".flags.network-uri = false;
      ...
      "vector-algorithms".flags.network-uri = false;
      ...
      "approximate".flags.network-uri = false;
      ...
      "parallel-io".flags.network-uri = false;
      ...
      "cpphs".flags.network-uri = false;
      "yesod-eventsource".revision = hackage."yesod-eventsource"."1.4.0".revisions.default;
      ...
      "yesod-eventsource".flags.network-uri = false;
      ...
      "iterable".flags.network-uri = false;
      "gtk".revision = hackage."gtk"."0.13.3".revisions.default;
      ...
      "iproute".flags.network-uri = false;
      ...
      "diagrams-core".flags.network-uri = false;
      ...
      "network-transport".flags.network-uri = false;
      ...
      "regex-applicative".flags.network-uri = false;
      ...
      "tasty-hunit".flags.network-uri = false;
      ...
      "pretty-show".flags.network-uri = false;
      ...
      "bson".flags.network-uri = false;
      "monad-logger".revision = hackage."monad-logger"."0.3.11".revisions.default;
      ...
      "monad-logger".flags.network-uri = false;
      ...
      "crypto-random-api".flags.network-uri = false;
      "mime-mail".revision = hackage."mime-mail"."0.4.6".revisions.default;
      ...
      "mime-mail".flags.network-uri = false;
      "hashable".revision = hackage."hashable"."1.2.3.0".revisions.default;
      ...
      "hashable".flags.network-uri = false;
      ...
      "hxt-charproperties".flags.network-uri = false;
      ...
      "quickcheck-io".flags.network-uri = false;
      "wai-extra".revision = hackage."wai-extra"."3.0.2.2".revisions.default;
      ...
      "wai-extra".flags.network-uri = false;
      ...
      "data-default-instances-containers".flags.network-uri = false;
      ...
      "stm-chans".flags.network-uri = false;
      ...
      "attoparsec".flags.network-uri = false;
      ...
      "blaze-html".flags.network-uri = false;
      ...
      "regex-pcre-builtin".flags.network-uri = false;
      ...
      "data-memocombinators".flags.network-uri = false;
      ...
      "freenect".flags.network-uri = false;
      ...
      "terminal-progress-bar".flags.network-uri = false;
      ...
      "numbers".flags.network-uri = false;
      "HTTP".revision = hackage."HTTP"."4000.2.18".revisions.default;
      ...
      "th-extras".flags.network-uri = false;
      ...
      "digest".flags.network-uri = false;
      ...
      "yesod-auth-fb".flags.network-uri = false;
      ...
      "MemoTrie".flags.network-uri = false;
      ...
      "BlastHTTP".flags.network-uri = false;
      ...
      "siphash".flags.network-uri = false;
      "options".revision = hackage."options"."1.2".revisions.default;
      ...
      "options".flags.network-uri = false;
      ...
      "haskell-packages".flags.network-uri = false;
      ...
      "colour".flags.network-uri = false;
      ...
      "transformers-base".flags.network-uri = false;
      ...
      "file-embed".flags.network-uri = false;
      ...
      "operational".flags.network-uri = false;
      ...
      "failure".flags.network-uri = false;
      ...
      "byteable".flags.network-uri = false;
      ...
      "mtlparse".flags.network-uri = false;
      ...
      "placeholders".flags.network-uri = false;
      ...
      "ghc-syb-utils".flags.network-uri = false;
      ...
      "regex-tdfa-rc".flags.network-uri = false;
      ...
      "hjsmin".flags.network-uri = false;
      ...
      "wl-pprint-extras".flags.network-uri = false;
      ...
      "ersatz".flags.network-uri = false;
      ...
      "language-glsl".flags.network-uri = false;
      ...
      "semigroupoid-extras".flags.network-uri = false;
      ...
      "strict".flags.network-uri = false;
      ...
      "entropy".flags.network-uri = false;
      ...
      "criterion".flags.network-uri = false;
      ...
      "monad-par-extras".flags.network-uri = false;
      "SafeSemaphore".revision = hackage."SafeSemaphore"."0.10.1".revisions.default;
      "SafeSemaphore".flags.test-hlint = false;
      "SafeSemaphore".flags.splitbase = true;
      "SafeSemaphore".flags.small_base = true;
      "SafeSemaphore".flags.https = true;
      "SafeSemaphore".flags.new-base = true;
      "SafeSemaphore".flags.blaze_html_0_5 = true;
      "SafeSemaphore".flags.old-locale = true;
      "SafeSemaphore".flags.bytestring-in-base = false;
      "SafeSemaphore".flags.network-uri = false;
      ...
      "matrix".flags.network-uri = false;
      "filepath".revision = hackage."filepath"."1.3.0.2".revisions.default;
      "yackage".revision = hackage."yackage"."0.7.0.5".revisions.default;
      ...
      "yackage".flags.network-uri = false;
      ...
      "hxt-pickle-utils".flags.network-uri = false;
      "auto-update".revision = hackage."auto-update"."0.1.2".revisions.default;
      ...
      "auto-update".flags.network-uri = false;
      ...
      "union-find".flags.network-uri = false;
      ...
      "runmemo".flags.network-uri = false;
      "resource-pool".revision = hackage."resource-pool"."0.2.3.1".revisions.default;
      ...
      "resource-pool".flags.network-uri = false;
      ...
      "asn1-types".flags.network-uri = false;
      ...
      "biopsl".flags.network-uri = false;
      ...
      "network-conduit-tls".flags.network-uri = false;
      ...
      "monad-loops".flags.network-uri = false;
      "digestive-functors".revision = hackage."digestive-functors"."0.7.1.1".revisions.default;
      ...
      "digestive-functors".flags.network-uri = false;
      ...
      "wai-eventsource".flags.network-uri = false;
      ...
      "unbounded-delays".flags.network-uri = false;
      ...
      "test-framework-quickcheck2".flags.network-uri = false;
      ...
      "phantom-state".flags.network-uri = false;
      ...
      "hspec-core".flags.network-uri = false;
      ...
      "stringsearch".flags.network-uri = false;
      ...
      "crypto-cipher-tests".flags.network-uri = false;
      ...
      "unix-compat".flags.network-uri = false;
      ...
      "rev-state".flags.network-uri = false;
      ...
      "nanospec".flags.network-uri = false;
      ...
      "monad-control".flags.network-uri = false;
      ...
      "tls".flags.network-uri = false;
      "list-t".revision = hackage."list-t"."0.3.0".revisions.default;
      ...
      "list-t".flags.network-uri = false;
      ...
      "yesod-gitrepo".flags.network-uri = false;
      ...
      "kan-extensions".flags.network-uri = false;
      ...
      "fay-base".flags.network-uri = false;
      ...
      "rainbow-tests".flags.network-uri = false;
      ...
      "scotty".flags.network-uri = false;
      "hasql-backend".revision = hackage."hasql-backend"."0.2.1".revisions.default;
      ...
      "hasql-backend".flags.network-uri = false;
      ...
      "tree-view".flags.network-uri = false;
      ...
      "file-location".flags.network-uri = false;
      ...
      "distributed-static".flags.network-uri = false;
      ...
      "wai-logger".flags.network-uri = false;
      ...
      "machines".flags.network-uri = false;
      ...
      "th-lift".flags.network-uri = false;
      ...
      "multipart".flags.network-uri = false;
      ...
      "numtype".flags.network-uri = false;
      ...
      "fay-text".flags.network-uri = false;
      ...
      "rest-types".flags.network-uri = false;
      ...
      "cryptocipher".flags.network-uri = false;
      ...
      "tostring".flags.network-uri = false;
      ...
      "fixed".flags.network-uri = false;
      "groundhog-postgresql".revision = hackage."groundhog-postgresql"."0.7.0".revisions.default;
      ...
      "groundhog-postgresql".flags.network-uri = false;
      "resourcet".revision = hackage."resourcet"."1.1.3.1".revisions.default;
      ...
      "resourcet".flags.network-uri = false;
      ...
      "diagrams".flags.network-uri = false;
      ...
      "fsnotify".flags.network-uri = false;
      ...
      "webdriver".flags.network-uri = false;
      ...
      "messagepack-rpc".flags.network-uri = false;
      ...
      "hmatrix-gsl".flags.network-uri = false;
      ...
      "hxt-unicode".flags.network-uri = false;
      ...
      "rest-core".flags.network-uri = false;
      ...
      "circle-packing".flags.network-uri = false;
      ...
      "abstract-par".flags.network-uri = false;
      ...
      "stateref".flags.network-uri = false;
      "wai-app-static".revision = hackage."wai-app-static"."3.0.0.3".revisions.default;
      ...
      "wai-app-static".flags.network-uri = false;
      "persistent-sqlite".revision = hackage."persistent-sqlite"."2.1.1".revisions.default;
      ...
      "persistent-sqlite".flags.network-uri = false;
      ...
      "http-types".flags.network-uri = false;
      ...
      "rfc5051".flags.network-uri = false;
      ...
      "pqueue".flags.network-uri = false;
      ...
      "pure-io".flags.network-uri = false;
      ...
      "imagesize-conduit".flags.network-uri = false;
      "bin-package-db".revision = hackage."bin-package-db"."0.0.0.0".revisions.default;
      "kure".revision = hackage."kure"."2.4.10".revisions.default;
      ...
      "diagrams-svg".flags.network-uri = false;
      ...
      "blastxml".flags.network-uri = false;
      ...
      "compdata".flags.network-uri = false;
      ...
      "log-domain".flags.network-uri = false;
      ...
      "random-shuffle".flags.network-uri = false;
      ...
      "pandoc-types".flags.network-uri = false;
      ...
      "repa-devil".flags.network-uri = false;
      ...
      "data-default-instances-base".flags.network-uri = false;
      ...
      "smallcheck".flags.network-uri = false;
      ...
      "http-date".flags.network-uri = false;
      ...
      "speculation".flags.network-uri = false;
      ...
      "fast-logger".flags.network-uri = false;
      ...
      "stm-conduit".flags.network-uri = false;
      ...
      "graphviz".flags.network-uri = false;
      ...
      "loch-th".flags.network-uri = false;
      ...
      "fixed-list".flags.network-uri = false;
      "path-pieces".revision = hackage."path-pieces"."0.1.4".revisions.default;
      ...
      "path-pieces".flags.network-uri = false;
      ...
      "patience".flags.network-uri = false;
      "conduit-extra".revision = hackage."conduit-extra"."1.1.5".revisions.default;
      ...
      "conduit-extra".flags.network-uri = false;
      ...
      "erf".flags.network-uri = false;
      "hasql-postgres".revision = hackage."hasql-postgres"."0.7.3".revisions.default;
      ...
      "hasql-postgres".flags.network-uri = false;
      ...
      "code-builder".flags.network-uri = false;
      ...
      "attoparsec-enumerator".flags.network-uri = false;
      ...
      "simple-sendfile".flags.network-uri = false;
      "hastache".revision = hackage."hastache"."0.6.0".revisions.default;
      ...
      "hastache".flags.network-uri = false;
      ...
      "tardis".flags.network-uri = false;
    };
    compiler = {
      version = "7.8.3";
      nix-name = "ghc783";
      ...
      self:
        super:
          ...
          in {
            ...
            "runghc-7.8.3" = dontCheck' (super."runghc-7.8.3");
            ...
            "ghci-7.8.3" = dontCheck' (super."ghci-7.8.3");
            ...
            "fpco-api" = dontCheck' (super."fpco-api");
            ...
            "pool-conduit" = dontCheck' (super."pool-conduit");
            ...
            "barecheck" = dontCheck' (super."barecheck");
            ...
            "ghc-7.8.3" = dontCheck' (super."ghc-7.8.3");
            ...
            "quickpull" = dontCheck' (super."quickpull");
            ...
            "attoparsec-conduit" = dontCheck' (super."attoparsec-conduit");
            ...
            "haddock-ghc-7.8.3" = dontCheck' (super."haddock-ghc-7.8.3");
            ...
            "ex-pool" = dontCheck' (super."ex-pool");
            ...
            "ghc-pkg-7.8.3" = dontCheck' (super."ghc-pkg-7.8.3");
            ...
            "shakespeare-i18n" = dontCheck' (super."shakespeare-i18n");
            ...
            "failure" = dontCheck' (super."failure");
            ...
            "rainbow-tests" = dontCheck' (super."rainbow-tests");
