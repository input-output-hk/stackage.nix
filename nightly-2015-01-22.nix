hackage:
  {
    packages = {
      ...
      "warp".revision = hackage."warp"."3.0.6".revisions.default;
      ...
      "linear".revision = hackage."linear"."1.16.1".revisions.default;
      ...
      "tttool".revision = hackage."tttool"."0.1".revisions.default;
      ...
      "cartel".revision = hackage."cartel"."0.12.0.2".revisions.default;
