hackage:
  {
    packages = {
      ...
      "descriptive".revision = hackage."descriptive"."0.9.2".revisions.default;
      ...
      "OpenGL".revision = hackage."OpenGL"."2.10.0.2".revisions.default;
      ...
      "shelly".revision = hackage."shelly"."1.6.1.1".revisions.default;
      ...
      "happstack-server".revision = hackage."happstack-server"."7.4.0".revisions.default;
      ...
      "persistent".revision = hackage."persistent"."2.1.1.6".revisions.default;
      ...
      "fay".revision = hackage."fay"."0.23.0.1".revisions.default;
