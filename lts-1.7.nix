hackage:
  {
    packages = {
      ...
      "warp".revision = hackage."warp"."3.0.8".revisions.default;
      ...
      "yesod-bin".revision = hackage."yesod-bin"."1.4.3.5".revisions.default;
      ...
      "yesod-test".revision = hackage."yesod-test"."1.4.3".revisions.default;
