hackage:
  {
    packages = {
      ...
      "http-client".revision = hackage."http-client"."0.4.8".revisions.default;
      ...
      "yesod-bin".revision = hackage."yesod-bin"."1.4.4".revisions.default;
      ...
      "contravariant".revision = hackage."contravariant"."1.2.2".revisions.default;
      ...
      "comonad".revision = hackage."comonad"."4.2.3".revisions.default;
