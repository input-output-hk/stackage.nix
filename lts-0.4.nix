hackage:
  {
    packages = {
      ...
      "yesod-bin".revision = hackage."yesod-bin"."1.4.2".revisions.default;
      ...
      "yesod-core".revision = hackage."yesod-core"."1.4.6.2".revisions.default;
      ...
      "yesod".revision = hackage."yesod"."1.4.1.2".revisions.default;
      ...
      "persistent".revision = hackage."persistent"."2.1.1.2".revisions.default;
      ...
      "keter".revision = hackage."keter"."1.3.7".revisions.default;
      ...
      "wai-app-static".revision = hackage."wai-app-static"."3.0.0.4".revisions.default;
      ...
      "persistent-sqlite".revision = hackage."persistent-sqlite"."2.1.1.1".revisions.default;
