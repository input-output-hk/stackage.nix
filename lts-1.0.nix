hackage:
  {
    packages = {
      ...
      "yesod-bin".revision = hackage."yesod-bin"."1.4.3.2".revisions.default;
      ...
      "HaXml".revision = hackage."HaXml"."1.25".revisions.default;
      ...
      "syb".revision = hackage."syb"."0.4.3".revisions.default;
