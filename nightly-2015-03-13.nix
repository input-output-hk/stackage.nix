hackage:
  {
    packages = {
      ...
      "hindent".revision = hackage."hindent"."4.4.0".revisions.default;
      ...
      "gl".revision = hackage."gl"."0.7.2.4".revisions.default;
      ...
      "network-attoparsec".revision = hackage."network-attoparsec"."0.12.1".revisions.default;
