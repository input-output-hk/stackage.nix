hackage:
  {
    packages = {
      ...
      "mtl-compat".revision = hackage."mtl-compat"."0.1.1".revisions.default;
      ...
      "gl".revision = hackage."gl"."0.7.2.2".revisions.default;
      ...
      "fay".revision = hackage."fay"."0.23.0.0".revisions.default;
