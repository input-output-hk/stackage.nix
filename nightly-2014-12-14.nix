hackage:
  {
    packages = {
      ...
      "product-profunctors".flags.network-uri = false;
      ...
      "mandrill".flags.network-uri = false;
      ...
      "stm-containers".revision = hackage."stm-containers"."0.2.6".revisions.default;
      ...
      "opaleye".flags.network-uri = false;
      ...
      "base-prelude".revision = hackage."base-prelude"."0.1.7".revisions.default;
      ...
      "raw-strings-qq".flags.network-uri = false;
      ...
      "hasql-postgres".revision = hackage."hasql-postgres"."0.8.0".revisions.default;
