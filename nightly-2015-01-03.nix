hackage:
  {
    packages = {
      ...
      "warp".revision = hackage."warp"."3.0.5".revisions.default;
      ...
      "constraints".revision = hackage."constraints"."0.4.1.2".revisions.default;
      ...
      "lzma-conduit".revision = hackage."lzma-conduit"."1.1.1".revisions.default;
      "yesod-auth".revision = hackage."yesod-auth"."1.4.1.2".revisions.default;
      ...
      "cabal-install".revision = hackage."cabal-install"."1.18.0.7".revisions.default;
      ...
      "stackage".revision = hackage."stackage"."0.4.0".revisions.default;
      ...
      "wai-extra".revision = hackage."wai-extra"."3.0.3.2".revisions.default;
      ...
      "conduit-extra".revision = hackage."conduit-extra"."1.1.6".revisions.default;
