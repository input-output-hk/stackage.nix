hackage:
  {
    packages = {
      ...
      "warp".revision = hackage."warp"."3.0.5.2".revisions.default;
      ...
      "shakespeare".revision = hackage."shakespeare"."2.0.3".revisions.default;
      ...
      "blaze-builder-conduit".revision = hackage."blaze-builder-conduit"."1.1.0".revisions.default;
      ...
      "formatting".revision = hackage."formatting"."6.1.1".revisions.default;
      ...
      "authenticate-oauth".revision = hackage."authenticate-oauth"."1.5.0.2".revisions.default;
      ...
      "rest-wai".revision = hackage."rest-wai"."0.1.0.5".revisions.default;
      ...
      "rest-happstack".revision = hackage."rest-happstack"."0.2.10.5".revisions.default;
      ...
      "linear".revision = hackage."linear"."1.16".revisions.default;
      ...
      "tasty-kat".revision = hackage."tasty-kat"."0.0.1".revisions.default;
      ...
      "gl".revision = hackage."gl"."0.7".revisions.default;
      ...
      "hoogle".revision = hackage."hoogle"."4.2.37".revisions.default;
      ...
      "hpc-coveralls".revision = hackage."hpc-coveralls"."0.8.1".revisions.default;
      ...
      "rest-snap".revision = hackage."rest-snap"."0.1.17.15".revisions.default;
      ...
      "base-prelude".revision = hackage."base-prelude"."0.1.14".revisions.default;
      "lucid".revision = hackage."lucid"."2.6.0".revisions.default;
      ...
      "process-extras".revision = hackage."process-extras"."0.3.0".revisions.default;
      ...
      "ieee754".revision = hackage."ieee754"."0.7.5".revisions.default;
      ...
      "c2hs".revision = hackage."c2hs"."0.21.1".revisions.default;
      ...
      "securemem".revision = hackage."securemem"."0.1.5".revisions.default;
      ...
      "RSA".revision = hackage."RSA"."2.1.0".revisions.default;
      ...
      "cpphs".revision = hackage."cpphs"."1.18.7".revisions.default;
      ...
      "hdocs".revision = hackage."hdocs"."0.4.1.1".revisions.default;
      ...
      "tls".revision = hackage."tls"."1.2.15".revisions.default;
      ...
      "rest-core".revision = hackage."rest-core"."0.34.0.1".revisions.default;
      ...
      self:
        super:
          ...
          in {
            ...
            "blaze-builder-conduit" = dontCheck' (super."blaze-builder-conduit");
