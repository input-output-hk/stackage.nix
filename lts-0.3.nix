hackage:
  {
    packages = {
      ...
      "yesod-bin".revision = hackage."yesod-bin"."1.4.1.1".revisions.default;
      ...
      "hmatrix".revision = hackage."hmatrix"."0.16.1.1".revisions.default;
      ...
      "yesod-websockets".revision = hackage."yesod-websockets"."0.2.1".revisions.default;
      ...
      "uuid".revision = hackage."uuid"."1.3.6".revisions.default;
      ...
      "list-t".revision = hackage."list-t"."0.3.1".revisions.default;
