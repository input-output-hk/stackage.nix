hackage:
  {
    packages = {
      ...
      "warp".revision = hackage."warp"."3.0.9.3".revisions.default;
      ...
      "http-client".revision = hackage."http-client"."0.4.8.1".revisions.default;
      ...
      "snap".revision = hackage."snap"."0.14.0".revisions.default;
      ...
      "yesod-bin".revision = hackage."yesod-bin"."1.4.5".revisions.default;
      ...
      "authenticate-oauth".revision = hackage."authenticate-oauth"."1.5.1".revisions.default;
      ...
      "yesod-core".revision = hackage."yesod-core"."1.4.8.2".revisions.default;
      ...
      "classy-prelude".revision = hackage."classy-prelude"."0.10.5".revisions.default;
      ...
      "groundhog".revision = hackage."groundhog"."0.7.0.2".revisions.default;
      ...
      "system-fileio".revision = hackage."system-fileio"."0.3.16.1".revisions.default;
      ...
      "tttool".revision = hackage."tttool"."1.1".revisions.default;
      ...
      "hspec-attoparsec".revision = hackage."hspec-attoparsec"."0.1.0.1".revisions.default;
      ...
      "hscolour".revision = hackage."hscolour"."1.21".revisions.default;
      "OpenGLRaw".revision = hackage."OpenGLRaw"."2.4.0.0".revisions.default;
      "hakyll".revision = hackage."hakyll"."4.6.7.0".revisions.default;
      ...
      "hspec-discover".revision = hackage."hspec-discover"."2.1.4".revisions.default;
      ...
      "opaleye".revision = hackage."opaleye"."0.3.1".revisions.default;
      ...
      "websockets".revision = hackage."websockets"."0.9.3.0".revisions.default;
      ...
      "classy-prelude-conduit".revision = hackage."classy-prelude-conduit"."0.10.5".revisions.default;
      ...
      "rainbow".revision = hackage."rainbow"."0.20.4.0".revisions.default;
      ...
      "effect-handlers".revision = hackage."effect-handlers"."0.1.0.2".revisions.default;
      "hsc2hs".revision = null;
      "directory".revision = hackage."directory"."1.2.1.0".revisions.default;
      "derive".revision = hackage."derive"."2.5.21".revisions.default;
      "hp2ps".revision = null;
      ...
      "mono-traversable".revision = hackage."mono-traversable"."0.9.0.1".revisions.default;
      "lzma-conduit".revision = hackage."lzma-conduit"."1.1.3".revisions.default;
      "yesod-auth".revision = hackage."yesod-auth"."1.4.3.1".revisions.default;
      ...
      "classy-prelude-yesod".revision = hackage."classy-prelude-yesod"."0.10.5".revisions.default;
      ...
      "OpenGL".revision = hackage."OpenGL"."2.11.1.0".revisions.default;
      ...
      "hlint".revision = hackage."hlint"."1.9.17".revisions.default;
      ...
      "happstack-server".revision = hackage."happstack-server"."7.4.1".revisions.default;
      ...
      "fay-builder".revision = hackage."fay-builder"."0.2.0.3".revisions.default;
      ...
      "c2hs".revision = hackage."c2hs"."0.24.1".revisions.default;
      ...
      "json-autotype".revision = hackage."json-autotype"."0.2.5.8".revisions.default;
      "contravariant".revision = hackage."contravariant"."1.3".revisions.default;
      ...
      "hoauth2".revision = hackage."hoauth2"."0.4.5".revisions.default;
      "persistent".revision = hackage."persistent"."2.1.1.7".revisions.default;
      ...
      "multiarg".revision = hackage."multiarg"."0.30.0.2".revisions.default;
      "comonad".revision = hackage."comonad"."4.2.4".revisions.default;
      "hspec".revision = hackage."hspec"."2.1.4".revisions.default;
      ...
      "cartel".revision = hackage."cartel"."0.14.2.0".revisions.default;
      ...
      "amqp".revision = hackage."amqp"."0.12.1".revisions.default;
      ...
      "mime-mail".revision = hackage."mime-mail"."0.4.8.1".revisions.default;
      ...
      "wai-extra".revision = hackage."wai-extra"."3.0.4.5".revisions.default;
      ...
      "attoparsec".revision = hackage."attoparsec"."0.12.1.3".revisions.default;
      ...
      "waitra".revision = hackage."waitra"."0.0.2.0".revisions.default;
      ...
      "prednote".revision = hackage."prednote"."0.32.0.0".revisions.default;
      ...
      "digestive-functors".revision = hackage."digestive-functors"."0.7.1.4".revisions.default;
      ...
      "hspec-core".revision = hackage."hspec-core"."2.1.4".revisions.default;
      ...
      "smoothie".revision = hackage."smoothie"."0.1.1".revisions.default;
      ...
      "fay".revision = hackage."fay"."0.23.1.1".revisions.default;
      ...
      "network-anonymous-i2p".revision = hackage."network-anonymous-i2p"."0.9.2".revisions.default;
      ...
      "kure".revision = hackage."kure"."2.16.8".revisions.default;
      ...
      "http-date".revision = hackage."http-date"."0.0.5".revisions.default;
      ...
      "fast-logger".revision = hackage."fast-logger"."2.3.0".revisions.default;
      ...
      self:
        super:
          ...
          in {
            ...
            "elm-build-lib" = dontCheck' (super."elm-build-lib");
            ...
            "elm-package" = dontCheck' (super."elm-package");
