hackage:
  {
    packages = {
      ...
      "warp".revision = hackage."warp"."3.0.10".revisions.default;
      ...
      "yesod-core".revision = hackage."yesod-core"."1.4.8.3".revisions.default;
      ...
      "generics-sop".revision = hackage."generics-sop"."0.1.1.1".revisions.default;
      ...
      "wai-extra".revision = hackage."wai-extra"."3.0.4.6".revisions.default;
