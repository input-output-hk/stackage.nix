hackage:
  {
    packages = {
      ...
      "monad-journal".revision = hackage."monad-journal"."0.6".revisions.default;
      ...
      "stackage".revision = hackage."stackage"."0.2.1.0".revisions.default;
      ...
      "uuid".revision = hackage."uuid"."1.3.7".revisions.default;
