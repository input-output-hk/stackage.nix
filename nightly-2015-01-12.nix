hackage:
  {
    packages = {
      ...
      "hsdev".revision = hackage."hsdev"."0.1.3.1".revisions.default;
      ...
      "mutable-containers".revision = hackage."mutable-containers"."0.2.0.1".revisions.default;
      ...
      "DRBG".revision = hackage."DRBG"."0.5.3".revisions.default;
      ...
      "stackage".revision = hackage."stackage"."0.5.1".revisions.default;
